...
// TODO: Inject Nodes/Profiles ViewModel or Repository to get real data
...
fun DomainRulesScreen(
    ...
    val allNodes = emptyList<com.openworld.app.model.NodeUi>()
    val nodesForSelection = emptyList<com.openworld.app.model.NodeUi>()
    val profiles = emptyList<com.openworld.app.model.ProfileUi>()
