...
import com.openworld.app.utils.StringBuilderPool
import com.openworld.app.utils.dns.DnsResolver
import com.openworld.app.utils.dns.DnsResolveStore
...
class ConfigRepository(private val context: Context) {
    ...
    private fun getProxyClient(): okhttp3.OkHttpClient? {
        val settings = cachedSettings ?: AppSettings()
        if (!com.openworld.app.ipc.VpnStateStore.getActive() || settings.proxyPort <= 0) {
            return null
        }
        val timeout = settings.subscriptionUpdateTimeout.toLong()
    ...
    fun deleteProfile(profileId: String) {
        // 取消自动更新任务
        com.openworld.app.service.SubscriptionAutoUpdateWorker.cancel(context, profileId)
