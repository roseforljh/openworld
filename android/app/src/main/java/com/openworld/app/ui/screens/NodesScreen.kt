...
import com.openworld.app.ui.components.AddNodeDialog
import com.openworld.app.ui.components.AddNodeTarget
import com.openworld.app.ui.components.InputDialog
import com.openworld.app.ui.components.NodeCard
import com.openworld.app.ui.components.NodeFilterDialog
                ...
                LazyColumn(
                    ...
                    itemsIndexed(
                        ...
                        val onEdit = remember(node.id) {
                            { navController.navigate(Screen.NodeDetail.nodeDetailRoute(node.group, node.name)) }
                        }
