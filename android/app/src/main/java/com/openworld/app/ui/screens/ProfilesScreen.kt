...
fun ProfilesScreen(
    ...
    viewModel: com.openworld.app.viewmodel.ProfilesViewModel = androidx.lifecycle.viewmodel.compose.viewModel()
) {
    ...
    var editingProfile by remember { mutableStateOf<com.openworld.app.model.ProfileUi?>(null) }
    ...
    androidx.compose.runtime.LaunchedEffect(importState) {
        when (val state = importState) {
            is com.openworld.app.viewmodel.ProfilesViewModel.ImportState.Success -> {
            ...
            is com.openworld.app.viewmodel.ProfilesViewModel.ImportState.Error -> {
    ...
    if (importState is com.openworld.app.viewmodel.ProfilesViewModel.ImportState.Loading) {
        ImportLoadingDialog(
            message = (importState as com.openworld.app.viewmodel.ProfilesViewModel.ImportState.Loading).message,
            ...
            LazyColumn(
                ...
                itemsIndexed(profiles, key = { _, profile -> profile.id }) { index, profile ->
                    ...
                    ProfileCard(
                        ...
                        onEdit = {
                            if (profile.type == com.openworld.app.model.ProfileType.Subscription ||
                                profile.type == com.openworld.app.model.ProfileType.Imported) {
