...
import com.openworld.app.model.EchConfig
...
import com.openworld.app.model.UdpOverTcpConfig
import com.openworld.app.model.WireGuardPeer
import com.openworld.app.repository.ConfigRepository
import com.openworld.app.ui.components.EditableSelectionItem
import com.openworld.app.ui.components.EditableTextItem
import com.openworld.app.ui.components.SelectProfileDialog
import com.openworld.app.ui.components.SelectProfileTarget
                    ...
                    StandardCard {
                            ...
                            EditableSelectionItem(
                                ...
                                onValueChange = { type ->
                                    val newTls = when (type) {
                                        ...
                                        "reality" -> tls.copy(enabled = true, reality = com.openworld.app.model.RealityConfig(enabled = true))
                                        else -> tls
                                    }
                        ...
                        if (securityType != "none") {
                            ...
                            EditableSelectionItem(
                                ...
                                icon = Icons.Rounded.Fingerprint,
                                onValueChange = { fp ->
                                    val newUtls = if (fp.isEmpty()) null else com.openworld.app.model.UtlsConfig(enabled = true, fingerprint = fp)
                            ...
                            if (securityType == "reality") {
                                val reality = tls.reality ?: com.openworld.app.model.RealityConfig(enabled = true)
                                Spacer(modifier = Modifier.height(8.dp))
                                EditableTextItem(
